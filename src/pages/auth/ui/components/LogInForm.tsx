...
import { AUTH_ENDPOINT, OAUTH_REDIRECT } from "@/api/endpoints";
...
export const LoginForm = () => {
	...
	const handleGitHubLogin = async () => {
		try {
			window.location.href = `${AUTH_ENDPOINT}/provider/github?redirect_to=${OAUTH_REDIRECT}`; // Redirect user to GitHub OAuth
		} catch (err) {
